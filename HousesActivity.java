...
public class HousesActivity extends AppCompatActivity {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.radioButton_today) {
                    ...
                    displayHouses();
                    Toast.makeText(HousesActivity.this, "今天", Toast.LENGTH_SHORT).show();
                } else if (checkedId == R.id.radioButton_tomorrow) {
                    selectedOption = "remainingRooms2";
                    displayHouses();
                    Toast.makeText(HousesActivity.this, "明天", Toast.LENGTH_SHORT).show();
                } else if (checkedId == R.id.radioButton_day_after_tomorrow) {
                    selectedOption = "remainingRooms3";
                    displayHouses();
                    Toast.makeText(HousesActivity.this, "后天", Toast.LENGTH_SHORT).show();
                }
            }
        });
        // 初始化变量的初始值
    ...
    private void displayHouses() {
        ...
        final Cursor cursor = db.rawQuery("SELECT id AS _id, house, location," + selectedOption + " FROM houses ",null);
                ...
                buttonOrder.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (remainingRooms > 0) {
                            ...
                            Toast.makeText(HousesActivity.this, "下单成功，已更新剩余房间", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(HousesActivity.this, "剩余房间不足，无法下单", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                return view;
